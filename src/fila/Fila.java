...
public class Fila {
    ...
    public int dequeue() {
        if(!isEmpty()) {
            ...
            throw new NoSuchElementException("Não possível realizar dequeue! empty");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        Fila mainFila = new Fila();

        mainFila.enqueue(1990);
        mainFila.enqueue(1991);
        mainFila.enqueue(2000);
